...
void InitScore(void)
{
	...
	//テクスチャの読み込み
	D3DXCreateTextureFromFile(pDevice, "number000.png", &g_pTextureScore);
	...
	{
		//頂点座標の設定（右回りで設定する）
		pVtx[0].pos = D3DXVECTOR3(SCREEN_WIDTH - (nScore*SCORE_SIZE_X + SCORE_SIZE_X / 2) - (SCORE_SIZE_X / 2) - 150, (SCREEN_HEIGHT - SCORE_SIZE_Y / 2) - (SCORE_SIZE_Y / 2) - 650, 0.0f);
		pVtx[1].pos = D3DXVECTOR3(SCREEN_WIDTH - (nScore*SCORE_SIZE_X + SCORE_SIZE_X / 2) + (SCORE_SIZE_X / 2) - 150, (SCREEN_HEIGHT - SCORE_SIZE_Y / 2) - (SCORE_SIZE_Y / 2) - 650, 0.0f);
		pVtx[2].pos = D3DXVECTOR3(SCREEN_WIDTH - (nScore*SCORE_SIZE_X + SCORE_SIZE_X / 2) - (SCORE_SIZE_X / 2) - 150, (SCREEN_HEIGHT - SCORE_SIZE_Y / 2) + (SCORE_SIZE_Y / 2) - 650, 0.0f);
		pVtx[3].pos = D3DXVECTOR3(SCREEN_WIDTH - (nScore*SCORE_SIZE_X + SCORE_SIZE_X / 2) + (SCORE_SIZE_X / 2) - 150, (SCREEN_HEIGHT - SCORE_SIZE_Y / 2) + (SCORE_SIZE_Y / 2) - 650, 0.0f);
