...
typedef enum
{
	...
	SOUND_LABEL_SE_SHOT2,		// オクトパスのショット音
	SOUND_LABEL_SE_SHOT3,		// ファイヤーバードのピンチ時のショット音
	SOUND_LABEL_SE_EXPLOSION,	// ヒット音
	SOUND_LABEL_SE_STAR,		// キラキラ音
	SOUND_LABEL_SE_ITEM,		// アイテム取得/復活音
