//=============================================================================
//
// X-Bow Hunterの処理 [title.cpp] (タイトル)
// Author:後藤慎之助
//
//=============================================================================
#include "title.h"
...
void InitTitle(void)
{
	...
	//テクスチャの読み込み
	D3DXCreateTextureFromFile(pDevice, "title001.png", &g_pTextureTitle[0]);
	D3DXCreateTextureFromFile(pDevice, "press_enter.png", &g_pTextureTitle[1]);
	D3DXCreateTextureFromFile(pDevice, "NORMAL000.png", &g_pTextureTitle[2]);
	D3DXCreateTextureFromFile(pDevice, "HARD000.png", &g_pTextureTitle[3]);
...
void UpdateTitle(void)
{
	...
	{
		pVtx[8].col = D3DCOLOR_RGBA(255, 255, 255, 155);
		pVtx[9].col = D3DCOLOR_RGBA(255, 255, 255, 155);
		pVtx[10].col = D3DCOLOR_RGBA(255, 255, 255, 155);
		pVtx[11].col = D3DCOLOR_RGBA(255, 255, 255, 155);

		pVtx[12].col = D3DCOLOR_RGBA(0, 0, 0, 255);
		pVtx[13].col = D3DCOLOR_RGBA(0, 0, 0, 255);
		pVtx[14].col = D3DCOLOR_RGBA(0, 0, 0, 255);
		pVtx[15].col = D3DCOLOR_RGBA(0, 0, 0, 255);
	}
	...
	if (g_nEnter == 1)
	{
		...
		//Enterキーを押した時
		if (g_nEnter2 == 0 && GetKeyboardPress(DIK_RETURN) && nFade == FADE_NONE)
		{
			PlaySound(SOUND_LABEL_SE_ENTER);	//プレスエンター音
