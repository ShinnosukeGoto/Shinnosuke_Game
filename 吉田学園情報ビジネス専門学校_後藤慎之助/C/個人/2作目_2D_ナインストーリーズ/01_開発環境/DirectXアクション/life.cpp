...
void InitLife(void)
{
	...
	PLAYER*pPlayer = GetPlayer();	//ハンターのストックを取得
	...
	pVtx[1].pos = D3DXVECTOR3(55 + 320 * (0.25*(pPlayer->nStock + 1)), (SCREEN_HEIGHT - LIFE_SIZE_Y / 2) - (LIFE_SIZE_Y / 2) - 625, 0.0f);
	pVtx[2].pos = D3DXVECTOR3(55, (SCREEN_HEIGHT - LIFE_SIZE_Y / 2) + (LIFE_SIZE_Y / 2) - 625, 0.0f);
	pVtx[3].pos = D3DXVECTOR3(55 + 320 * (0.25*(pPlayer->nStock + 1)), (SCREEN_HEIGHT - LIFE_SIZE_Y / 2) + (LIFE_SIZE_Y / 2) - 625, 0.0f);
	...
	pVtx[1].tex = D3DXVECTOR2((pPlayer->nStock + 1) * 0.25f, 0.0f);
	pVtx[2].tex = D3DXVECTOR2(0.0f, 1.0f);
	pVtx[3].tex = D3DXVECTOR2((pPlayer->nStock + 1) * 0.25f, 1.0f);
