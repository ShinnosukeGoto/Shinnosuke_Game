//=============================================================================
//
// ナインストーリーズの処理 [result2.cpp] (ランキング)
// Author:後藤慎之助
//
//=============================================================================
...
//グローバル変数宣言
//=============================================================================
LPDIRECT3DTEXTURE9 g_pTextureResult2[6] = {};//テクスチャへのポインタ
...
void InitResult2(void)
{
	...
	//テクスチャの読み込み
	D3DXCreateTextureFromFile(pDevice, "TEXTURE/gameend002.png", &g_pTextureResult2[0]);	//かけだしハンター
	D3DXCreateTextureFromFile(pDevice, "TEXTURE/number000.png", &g_pTextureResult2[1]);		//ナンバー
	D3DXCreateTextureFromFile(pDevice, "TEXTURE/gameend003.png", &g_pTextureResult2[2]);	//一人前ハンター
	D3DXCreateTextureFromFile(pDevice, "TEXTURE/gameend004.png", &g_pTextureResult2[3]);	//ベテランハンター
	D3DXCreateTextureFromFile(pDevice, "TEXTURE/gameend001.png", &g_pTextureResult2[4]);	//ジェノサイドハンター
	D3DXCreateTextureFromFile(pDevice, "TEXTURE/gameend005.png", &g_pTextureResult2[5]);	//三流ハンター
...
{
	//テクスチャの開放
	for (int nCntResultScore = 0; nCntResultScore < 6; nCntResultScore++)
	{
		if (g_pTextureResult2[nCntResultScore] != NULL)
		{
...
void DrawResult2(void)
{
	...
	//スコア0～49999pt
	if (g_nResultScore >= 0 && g_nResultScore < 50000)
	{
		//テクスチャの設定
	...
	//スコア50000～119999pt
	if (g_nResultScore >= 50000 && g_nResultScore < 120000)
	{
		//テクスチャの設定
	...
	//スコア120000～179999pt
	if (g_nResultScore >= 120000 && g_nResultScore < 180000)
	{
		//テクスチャの設定
	...
	//スコア180000～199999pt
	if (g_nResultScore >= 180000 && g_nResultScore < 200000)
	{
		//テクスチャの設定
