...
HRESULT CModelEffect::Load(void)
{
    ...
    //==============================
    // モデル
    D3DXLoadMeshFromX(LPCSTR("data/MODEL/Debri/all.x"), D3DXMESH_SYSTEMMEM, pDevice, NULL,
        &m_apBuffMat[TYPE_DEBRI_ALL], NULL, &m_aNumMat[TYPE_DEBRI_ALL], &m_apMesh[TYPE_DEBRI_ALL]);
    // テクスチャ
    D3DXCreateTextureFromFile(pDevice, "data/TEXTURE/stone.jpg", &m_apTexture[TYPE_DEBRI_ALL]);
